...
def make_odf_score_sheets(
    ...
    for i in indexes:
        ...
        summary_spacer_column_style_name = "SummarySpacerColumnStyle" + str(
            tournament.ring
        )
        ...
        for j in range(0, len(tournament.event_entries), 1):
            ...
            tc.addElement(
                P(
                    text=tournament.event_entries[j].letter
                    + " -  "
            ...
            tc.addElement(
                P(
                    text=tournament.event_entries[j].entry.driver1,
            ...
            tc.addElement(
                P(
                    text=tournament.event_entries[j].entry.school,
                    stylename=robot_summary_detail_paragraph_style_name,
                )
            )
            tr1.addElement(tc)
    ...
    # Save the document
    file_name = "scoresheet_" + event.id + ".odt"
