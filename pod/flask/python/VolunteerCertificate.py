...
def make_odf_volunteer_certificate_odoc(
    ...
    teletype.addTextToElement(
        p, "This is to acknowledge the\nenthusiastic volunteer support of\n"
    )
    # volunteer name
    p.addElement(Span(stylename=big_caslon_pro_26pt_bold, text=name))
    ...
    p.addElement(
        Span(
            text="who contributed greatly to the success of the",
