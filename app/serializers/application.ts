...
export default class SupabaseSerializer extends RESTSerializer {
  ...
  public normalizeResponse(
    ...
    requestType: string
      ...
      let name = "";
      if(typeof primaryModelClass.modelName === 'string'){
        name = primaryModelClass.modelName;
      }else{
        name = primaryModelClass.modelName.toString();
      }
  ...
  public normalizeSingleResponse(
    ...
    requestType: string
      ...
      const record = payload[pluralize(name)];
      //const record = payload[primaryModelClass.modelName];
      if(record){
